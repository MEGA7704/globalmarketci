...
console.log('[validate V6.1.3] OK — restauration forensique des commandes client depuis D1, patches, snapshots/backups, caches KV et opérations différées.');
