...
console.log('[validate V6.0.4] OK — Pages déployable sans R2 ni Worker temps réel préexistants; D1 relationnel actif, R2 et WebSocket restent activables ensuite.');
