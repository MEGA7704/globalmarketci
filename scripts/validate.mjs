...
console.log('[validate V6.1.2] OK — anciennes commandes client restaurées par identité, patches historiques et D1 relationnel, sans effacement d’un historique visible.');
