...
async function cloudSaveNow(d=CLOUD_DATA){if(!d||!CLOUD_SESSION) return; const r=await fetchWithTimeout('/api/save',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({data:d})},15000); await readApiPayload(r)}
