  ...
  <div class="modalCard gmRegisterModalCard" role="dialog" aria-modal="true" aria-labelledby="registerTitle" aria-describedby="registerDescription">
    ...
    <header class="gmRegisterHeader">
      ...
      <div class="gmRegisterHeadingText">
        ...
        <p class="registerSub" id="registerDescription"><strong>IDENTIFICATION DE L’ENTREPRISE</strong><span>Remplissez correctement les champs. Tous les textes saisis restent visibles et lisibles.</span></p>
      </div>
    </header>
...
function secureErrorMessage(error,fallback='Opération sécurisée impossible.'){
  ...
  if(error?.code==='SETUP_REQUIRED') return 'Le secret Cloudflare SUPER_ADMIN_INITIAL_PASSWORD doit être configuré avant la première connexion Super Admin.';
